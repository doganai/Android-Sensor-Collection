...
public class InfoActivity extends AppCompatActivity {
    ...
    EditText emailEdit;
    EditText genderEdit;
    EditText currentDateEdit;
    EditText currentTimeEdit;
    ...
    public void saveInfo(View view){
        ...
        File userFile = new File(acc.getAbsolutePath()+ "/UserFiles" + "/info_stand-sit-lie_" + email + "_" + t +".txt");
        ...
        try {
            outputStream = new FileOutputStream(acc.getAbsolutePath() + "/UserFiles" + "/info_stand-sit-lie_" + email + "_" + t +".txt");
