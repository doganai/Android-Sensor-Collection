...
public class CollectActivityHandFall3 extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_collect_activity_hand_fall3);
    ...
    private void writeToExternal(String data)//WRITE TO EXTERNAL
    {
        ...
        File userFile = new File(acc.getAbsolutePath() + "/UserFiles" + "/lieFallHand_" + newAct +  ".txt");
        ...
        try {
            outputStream = new FileOutputStream(acc.getAbsolutePath() + "/UserFiles" + "/lieFallHand_" + newAct +  ".txt", true);
    ...
    public void stopButton(View view){
        ...
        //Creates New Intent
        Intent startNewActivity = new Intent(this, CollectActivityPocket3.class);
