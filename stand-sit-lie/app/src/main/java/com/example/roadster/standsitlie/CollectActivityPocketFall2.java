...
public class CollectActivityPocketFall2 extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_collect_activity_pocket_fall2);
    ...
    private void writeToExternal(String data)//WRITE TO EXTERNAL
    {
        ...
        File userFile = new File(acc.getAbsolutePath() + "/UserFiles" + "/sitFallPocket_" + newAct +  ".txt");
        ...
        try {
            outputStream = new FileOutputStream(acc.getAbsolutePath() + "/UserFiles" + "/sitFallPocket_" + newAct +  ".txt", true);
    ...
    public void stopButton(View view){
        ...
        //Creates New Intent
        Intent startNewActivity = new Intent(this, CollectActivityHand3.class);
