...
public class CollectActivityHandFall1 extends AppCompatActivity implements SensorEventListener {
    ...
    private void writeToExternal(String data)//WRITE TO EXTERNAL
    {
        ...
        File userFile = new File(acc.getAbsolutePath() + "/UserFiles" + "/standFallHand_" + newAct +  ".txt");
        ...
        try {
            outputStream = new FileOutputStream(acc.getAbsolutePath() + "/UserFiles" + "/standFallHand_" + newAct +  ".txt", true);
