...
public class CollectActivityPocketFall1 extends AppCompatActivity implements SensorEventListener {
    ...
    Handler handler;
    int timeRemaining = 20000;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_collect_activity_pocket_fall1);
    ...
    private void writeToExternal(String data)//WRITE TO EXTERNAL
    {
        ...
        File userFile = new File(acc.getAbsolutePath() + "/UserFiles" + "/walkFallPocket_" + newAct +  ".txt");
        ...
        try {
            outputStream = new FileOutputStream(acc.getAbsolutePath() + "/UserFiles" + "/walkFallPocket_" + newAct +  ".txt", true);
    ...
    public void stopButton(View view){
        ...
        //Creates New Intent
        Intent startNewActivity = new Intent(this, CollectActivityHand2.class);
