...
public class CollectActivityPocketFall2 extends AppCompatActivity implements SensorEventListener {
    ...
    private void writeToExternal(String data)//WRITE TO EXTERNAL
    {
        ...
        File userFile = new File(acc.getAbsolutePath() + "/UserFiles" + "/jogFallPocket_" + newAct +  ".txt");
        ...
        try {
            outputStream = new FileOutputStream(acc.getAbsolutePath() + "/UserFiles" + "/jogFallPocket_" + newAct +  ".txt", true);
