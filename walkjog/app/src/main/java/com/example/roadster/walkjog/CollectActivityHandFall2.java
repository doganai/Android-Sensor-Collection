...
public class CollectActivityHandFall2 extends AppCompatActivity implements SensorEventListener {
    ...
    private void writeToExternal(String data)//WRITE TO EXTERNAL
    {
        ...
        File userFile = new File(acc.getAbsolutePath() + "/UserFiles" + "/jogFallHand_" + newAct +  ".txt");
        ...
        try {
            outputStream = new FileOutputStream(acc.getAbsolutePath() + "/UserFiles" + "/jogFallHand_" + newAct +  ".txt", true);
