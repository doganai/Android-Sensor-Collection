...
public class CollectActivityHandFall1 extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_collect_activity_hand_fall1);
    ...
    private void writeToExternal(String data)//WRITE TO EXTERNAL
    {
        ...
        File userFile = new File(acc.getAbsolutePath() + "/UserFiles" + "/walkFallHand_" + newAct +  ".txt");
        ...
        try {
            outputStream = new FileOutputStream(acc.getAbsolutePath() + "/UserFiles" + "/walkFallHand_" + newAct +  ".txt", true);
    ...
    public void stopButton(View view){
        ...
        //Creates New Intent
        Intent startNewActivity = new Intent(this, CollectActivityPocket1.class);
